// Función para obtener datos de las API de TMDb y actualizar la página con la información de las seis películas de amor más valoradas
function obtenerDatosPeliculas() {
    // Llamada a la API de TMDb para obtener la información de las seis películas de amor más valoradas
    fetch('https://api.themoviedb.org/3/discover/movie?api_key=71fd9eceae3ba5b0a483b1f99ef576b3&language=es&sort_by=vote_average.desc&vote_count.gte=1000&with_genres=10749')
